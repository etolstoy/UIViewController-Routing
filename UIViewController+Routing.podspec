#
#  Be sure to run `pod spec lint UIViewController+Routing.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/igrekde/UIViewController-Routing"
  ...
  s.author             = { "igrekde" => "igrekde@gmail.com" }
  s.social_media_url   = "http://twitter.com/igrekde"
